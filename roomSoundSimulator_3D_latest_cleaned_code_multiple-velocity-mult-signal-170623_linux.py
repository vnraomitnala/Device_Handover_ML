...
for i in range(len(standardRoom_mic_locs)):
    ...
    mic_array = pra.circular_microphone_array_xyplane(standardRoom_mic_locs[i], num_mic_arrays, 0, 0.1, room.fs)
...
with open ('datasetFinal_randum_locus_dev-clean1-10-200-100-2.pickle', 'wb' ) as f:
    pickle.dump(datasetFinal, f) 
    
with open ('travelTimeDataset_dev-clean1-10-200-100-2.pickle', 'wb' ) as f:
