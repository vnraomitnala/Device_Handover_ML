# -*- coding: utf-8 -*-
"""
Created on Sat Jul 15 14:09:53 2023
...
with open ('C:/Users/Vijaya/PhD/chapter5/datasetFinal_randum_locus_str3.pickle', 'rb') as f:
...
# Add Conv1D layer
model.add(Conv1D(filters=124, kernel_size=92, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=120, kernel_size=90, strides=1, activation='relu', padding='same'))
#model.add(MaxPooling1D(2))
model.add(Conv1D(filters=114, kernel_size=88, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=102, kernel_size=55, strides=1, activation='relu', padding='same'))
