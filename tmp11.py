...
# =============================================================================
        ...
        for j in range (len(locus)):
            ...
            for i in range(len(standardRoom_mic_locs)):
                ...
                room_tmp.add_source(locus[j], signal=sig, directivity=None) 
...
with open ('datasetFinal_random_locus_dev-clean1-sig1.pickle', 'wb' ) as f:
    pickle.dump(datasetFinal, f) 
    
with open ('travelTimeDataset_random_locus_dev-clean1-sig1.pickle', 'wb' ) as f:
