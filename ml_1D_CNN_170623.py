...
# =============================================================================
# with open ('C:/Users/Vijaya/PhD/chapter5/SignalDataset/datasetFinal_randum_locus_dev-clean1-10-locus-20000.pickle', 'rb') as f:
#      audio_features_dataset_10_locus_1 = pickle.load(f)                
# 
# with open ('C:/Users/Vijaya/PhD/chapter5/SignalDataset/distanceDataset_randum_locus_dev-clean1-10-20000.pickle', 'rb') as f:
#      distance_dataset_10_locus_1 = pickle.load(f)
# =============================================================================
     
# =============================================================================
# with open ('C:/Users/Vijaya/PhD/chapter5/SignalDataset/datasetFinal_randum_locus_dev-clean1-10-locus-1000.pickle', 'rb') as f:
#      audio_features_dataset_10_locus_1 = pickle.load(f)                
# 
...
# Add Conv1D layer
model.add(Conv1D(filters=128, kernel_size=200, strides=1, activation='relu', padding='same'))
#model.add(MaxPooling1D(2))
model.add(Conv1D(filters=64, kernel_size=100, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=32, kernel_size=50, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=16, kernel_size=25, strides=1, activation='relu', padding='same'))
...
plt.savefig('transition_linear.pdf')
