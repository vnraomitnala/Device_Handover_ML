...
velocity_list = [ 1.0  +i*0.5 for i in range(1)]
...
for i in range(len(standardRoom_mic_locs)):
    ...
    mic_array = pra.circular_microphone_array_xyplane(center=standardRoom_mic_locs[i],  M=num_mic_arrays, phi0=0, radius=0.55, fs=room.fs, directivity=directivity)
...
with open ('datasetFinal_randum_locus_dev-clean1-lnear-move-sig1.pickle', 'wb' ) as f:
    pickle.dump(datasetFinal, f) 
    
with open ('travelTimeDataset_dev-clean1-lnear-move-sig1.pickle', 'wb' ) as f:
