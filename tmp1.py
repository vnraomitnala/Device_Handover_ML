...
str3 = "female3.wav"
str4 = "female4.wav"
str5 = "baby_crying.wav"
str6 = "male.wav"

directory1 = "C:/Users/Vijaya/Documents/MobaXterm/home/chapter5/dev-clean1-converted-10"
...
standardRoom_source_locs = [ [ 0.5 +i*0.6,1, 1.4] for i in range(10) ]
...
# =============================================================================
    ...
    for l in range(1):
        ...
        travel_time = stats.uniform(0.0, duration).rvs(10).tolist()        
        travel_time.sort()
...
# =============================================================================
        ...
        for j in range (len(locus)):
            ...
            for i in range(len(standardRoom_mic_locs)):
                ...
                sig = librosa.util.fix_length(sig,size=(len(sig)))
                ...
                if i == 0: # mic1
                    ...
                    if j > 0 and int(mic1_abs) > 50: #and int(mic1_abs) <= 100000 :
                        ...
                        sf.write( str4, (tmp_final1/3).T.astype(np.int16), room.fs)
...
# =============================================================================
                    ...
                    if j > 0 and int(mic2_abs) > 50: # and int(mic2_abs) <= 100000 :
                        ...
                        sf.write(str5, (tmp_final2/3).T.astype(np.int16), room.fs)  

# =============================================================================
#                         data, samplerate  = sf.read(str5, dtype='int16')  
#                                 
#                         data_0 = np.hanning(len(data[:index, 0])) * data[:index, 0]
#                         data_1 = np.hanning(len(data[:index, 1])) * data[:index, 1] 
#                         
