...
with open ('datasetFinal_linear_locus_dev-clean1-0.8.pickle', 'wb' ) as f:
    pickle.dump(datasetFinal, f) 
    
with open ('travelTimeDataset_linear_locus_dev-clean1-0.8.pickle', 'wb' ) as f:
