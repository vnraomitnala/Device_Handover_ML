...
# Add Conv1D layer
model.add(Conv1D(filters=128, kernel_size=25, strides=1, activation='relu', padding='same'))
#model.add(MaxPooling1D(2))
model.add(Conv1D(filters=64, kernel_size=25, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=32, kernel_size=20, strides=1, activation='relu', padding='same'))

model.add(Conv1D(filters=16, kernel_size=10, strides=1, activation='relu', padding='same'))
...
with open ('C:/Users/Vijaya/PhD/chapter5/SignalDataset/model_100_200_100.pickle', 'wb' ) as f:
    pickle.dump(model, f) 