...
for i in range(len(standardRoom_mic_locs)):
    ...
    R = pra.circular_2D_array(standardRoom_mic_locs[i][:2], 2, 0, 0.1)
...
# =============================================================================
            ...
            if j > 0 and mic1_abs > 50 and mic2_abs > 50:
                k= k+1   
...
# =============================================================================
# with open ('C:/Users/Vijaya/PhD/chapter5/datasetFinal_randum_locus_strs_multiple.pickle', 'wb' ) as f:
#     pickle.dump(datasetFinal, f) 
#     
# with open ('C:/Users/Vijaya/PhD/chapter5/travelTimeDataset_strs_multiple.pickle', 'wb' ) as f:
#     pickle.dump(travelTimeDataset, f)     
# 
# =============================================================================
 
with open ('datasetFinal_random_locus_dev-clean1.pickle', 'wb' ) as f:
    pickle.dump(datasetFinal, f) 
    
with open ('travelTimeDataset_random_locus_dev-clean1.pickle', 'wb' ) as f:
    pickle.dump(travelTimeDataset, f)  
