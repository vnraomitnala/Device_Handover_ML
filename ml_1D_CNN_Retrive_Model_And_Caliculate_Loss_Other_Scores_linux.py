...
with open ('datasetFinal_random_locus_dev-clean1-10-200-50.pickle', 'rb') as f:
     audio_features_dataset_10_locus_1 = pickle.load(f)                

with open ('distanceDataset_random_locus_dev-clean1-10-200-50.pickle', 'rb') as f:
...
with open ('model_10_200_50.pickle', 'rb' ) as f:
    model = pickle.load(f)
